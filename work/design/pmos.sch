...
N 220 40 320 40 {
lab=VGS}
C {sky130_fd_pr/pfet_01v8.sym} 60 40 0 0 {name=M1
L=\{L\}
W=\{W\}
nf=\{F\} 
mult=\{M\}
...
C {devices/launcher.sym} 670 80 0 0 {name=h15
descr="Annotate OP" 
...
C {devices/simulator_commands_shown.sym} 600 -60 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=false 
value="
...
"}
C {devices/lab_wire.sym} -50 40 0 1 {name=p12 sig_type=std_logic lab=VGS}
C {devices/lab_wire.sym} 80 -60 0 1 {name=p3 sig_type=std_logic lab=VDS}
C {sky130_fd_pr/pfet_01v8_lvt.sym} 340 40 0 0 {name=M2
L=\{L\}
W=\{W\}
nf=\{F\} 
mult=\{M\}
